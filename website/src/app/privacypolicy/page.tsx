          ...
          <div className="prose prose-blue max-w-none text-gray-600">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg mb-10">
              ...
              <p className="text-blue-800 font-medium m-0">
                We don&apos;t collect your personal data. Everything stays on your device or in your personal Google Drive. There are no ads. We use Firebase to monitor anonymous app usage analytics (like active installations and screens viewed) strictly to improve app stability, and Firebase Cloud Messaging (FCM) to deliver real-time calendar changes.
              </p>
            </div>
            ...
            <div className="space-y-10">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Advertising, Analytics &amp; Push Notifications</h2>
                <p className="mb-4">Reality contains <strong>zero advertisements</strong>. We do not sell, rent, or share your data with advertisers or data brokers.</p>
                <p className="mb-4">Reality uses <strong>Firebase (a Google service)</strong> to deliver silent push notifications for Google Calendar sync (FCM) and to collect anonymous app usage analytics (such as active installations and screens viewed) to help us monitor and improve the app.</p>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>What Firebase receives:</strong> An anonymous device token and basic app state metrics. No personal data, user files, accounts, or specific app content is ever transmitted.</li>
                  <li><strong>What Firebase does NOT do:</strong> We do not track personal profiles, user keystrokes, browser search history, or any personal details.</li>
